    ...
    <div className="bg-background">
      <section className="relative overflow-hidden border-b border-border">
        ...
        <motion.div
          ...
          animate={
            shouldReduceMotion ? undefined : { x: [0, 24, 0], y: [0, -12, 0], scale: [1, 1.06, 1] }
          }
        ...
        <motion.div
          ...
          animate={
            shouldReduceMotion ? undefined : { x: [0, -20, 0], y: [0, 16, 0], scale: [1, 1.08, 1] }
          }
      ...
      <main className="container mx-auto space-y-14 px-4 py-10 sm:space-y-16 sm:py-14 lg:space-y-20 lg:py-16">
                ...
                <div className="mt-5 flex flex-col gap-3 xl:flex-row">
                  {activeStage.highlights.map(highlight => (
                    <motion.div
                      ...
                      className="rounded-2xl border border-border/70 bg-muted/10 px-4 py-3 text-sm text-foreground xl:flex-1"
                    >
                      {highlight}
                    </motion.div>
                  ))}
        ...
        >
          <div className="max-w-4xl space-y-3">
            ...
            <p className="text-sm leading-7 text-muted-foreground sm:text-base">
              아래 활동을 눌러 보면 실제로 어떤 방식으로 동아리가 움직이는지 상세하게 확인할 수
              있습니다.
            </p>
          </div>
