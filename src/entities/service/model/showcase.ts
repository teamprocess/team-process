...
import clashOverview from "../../../../public/services/clash-overview.png";
import sh4reOverview from "../../../../public/services/sh4re-overview.png";
...
export const SERVICE_SHOWCASES: ServiceShowcase[] = [
  {
    ...
    description:
      "Sh4re는 정보 수업에서 반복적으로 발생하던 과제 제출과 확인의 불편을 줄이기 위해 만든 학습 관리 플랫폼입니다. 교사는 과제를 더 효율적으로 관리할 수 있고, 학생은 제출 결과를 더 직관적으로 확인할 수 있도록 과제 운영 흐름 전반을 수업 환경에 맞게 설계했습니다.",
    note: "Velog 월간 1위를 기록한 소개글을 통해 프로젝트의 배경과 방향을 함께 확인할 수 있습니다.",
    features: ["과제 대시보드", "웹 뷰어", "파이썬 과제 자동 채점", "수업자료 공유", "코드 공유"],
    links: [
      {
        label: "Velog 소개글",
